...
export const GrantChartCurrent = () => {
    ...
    for (var i = 0; i < graphData.series[0].data.length; i++) {
      if (graphData.series[0].data[i].y[1] < Date.now()) {
        delete graphData.series[0].data[i].y[1]
      }
    }
